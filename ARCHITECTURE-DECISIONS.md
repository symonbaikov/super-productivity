...
| **Notes stay dateless** — a `Note` carries no due/review date or reminder; note reminders shipped and were removed in 2021 (`251e3cce1`) and a dated item is a task | [`docs/notes-with-dates-decision.md`](docs/notes-with-dates-decision.md)                                                                                                                                                                                         |

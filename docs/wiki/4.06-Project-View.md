...
- Removes it from the sidebar and the visibility menu
- Keeps all tasks and project data intact
- Does not affect any task in other projects

To **unarchive** a project, click the eye icon in the Projects section header to open the visibility menu. Archived projects appear at the bottom, below a divider, with an unarchive icon. Click the project name to restore it.
